               ...
               <div class="card height-auto">
                   <div class="card-body">
                       <div class="heading_1">
                        ...
                        {{$testingForm->prop}}
                        <form class="lecture_form" action="{{route('editTest', $testingForm->id)}}" method="post">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-12-xxl col-lg-12 col-12 form-group">
                                    <label>Вопросы теста </label>
                                    <textarea type="text" name="question" class="form-control">{{$testingForm->question}}</textarea>
                                </div>   
                                <div class="col-4-xxl col-lg-6 col-12 form-group">
                                    <label>Вариант А </label>
                                    <input type="text" name="optionA" class="form-control" autocomplete="off" value="{{$testingForm->optionA}}">
                                </div>   
                                <div class="col-4-xxl col-lg-6 col-12 form-group">
                                    <label>Вариант В </label>
                                    <input type="text" name="optionB" class="form-control" autocomplete="off" value="{{$testingForm->optionB}}">
                                </div>   
                                <div class="col-4-xxl col-lg-6 col-12 form-group">
                                    <label>Вариант С </label>
                                    <input type="text" name="optionC" class="form-control" autocomplete="off" value="{{$testingForm->optionC}}">
                                </div>   
                                <div class="col-4-xxl col-lg-6 col-12 form-group">
                                    <label>Вариант D </label>
                                    <input type="text" name="optionD" class="form-control" autocomplete="off" value="{{$testingForm->optionD}}">
                                </div>   
                                <div class="col-4-xxl col-lg-6 col-12 form-group">
                                    <label>Правильный ответ</label>
                                    <input type="text" name="correct_answer" class="form-control" autocomplete="off" value="{{$testingForm->correct_answer}}">
                                </div>  
                                <div class="col-4-xxl col-lg-6 col-12 form-group">
