               ...
               <div class="card height-auto">
                   <div class="card-body">
                       <div class="heading_1">
                        ...
                        <form class="lecture_form" action="{{route('addLecture')}}" method="post">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-4-xxl col-lg-6 col-12 form-group">
                                    <label>Название лекции *</label>
                                    <input type="text" name="name_lectures" class="form-control" autocomplete="off" placeholder>
                                </div>
                                <div class="col-4-xxl col-lg-6 col-12 form-group">
                                    <label>Коротко о лекции *</label>
                                    <input type="text" name="short_desc" class="form-control" autocomplete="off" placeholder="не более 50 слов">
                                </div>
                                <div class="col-4-xxl col-lg-6 col-12 form-group">
                                    <label>Ссылка лекции в Youtube *</label>
                                    <input type="text" name="url_lectures" class="form-control" autocomplete="off" placeholder>
                                </div>
                                <div class="col-12-xxl col-lg-6 col-12 form-group">
                                    <label>Описание лекции *</label>
                                    <textarea class="textarea form-control" type="text" name="description_lectures" cols="10" rows="4"></textarea>
                                </div>
                                ...
                                <table class="table display data-table text-nowrap dataTable no-footer" id="DataTables_0" role="grid">
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="odd">
                                            <td>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" name="select_id" />
                                            ...
                                            <td>
                                                <div class="panel">
                                                    <a class="dropdown-item" href="{{route('lectureInform', $a->id)}}">
                                                        <i class="fas fa-book-reader text-green"></i>
                                                        Открыть
                                                    </a>
