            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="new_form" action="{{ route('editAdminAccount', $admin->id)}}" method="post">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Фамилия *</label>
                                    <input class="form-control" type="text" name="firstname" value="{{$admin->firstname}}" required="required" autocomplete="off">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Имя *</label>
                                    <input class="form-control" type="text" name="lastname" value="{{$admin->lastname}}" required="required" autocomplete="off">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Пол *</label>
                                    <input class="form-control" type="text" name="gender" value="{{$admin->gender}}" required="required" autocomplete="off">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Дата рождения *</label>
                                    <input class="form-control air-datepicker" type="text" data-position="bottom right" name="admin_birthday" value="{{$admin->admin_birthday}}" required="required" autocomplete="off">
                                    <i class="far fa-calendar-alt"></i>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Мобильный телефон *</label>
                                    <input class="form-control" type="text" name="mobile_phone" value="{{$admin->mobile_phone}}" required="required" autocomplete="off">
                                </div>
                                <div class="col-lg-6 col-12 form-group">
                                    <label>Адресс *</label>
                                    <textarea class="textarea form-control" type="text" name="address" cols="10" rows="4">{{$admin->address}}</textarea>
                                </div>
